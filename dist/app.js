...
let writeDraft; // Implemented by portal.js after authentication.
...
let saveReport; // Implemented by portal.js after authentication.
$('#visitForm').onsubmit=async e=>{e.preventDefault();$('#save').disabled=true;try{await saveReport();}finally{$('#save').disabled=false;}};
let renderHistory; // Implemented by portal.js after authentication.
...
// portal.js restores drafts only after Supabase has verified the login.
